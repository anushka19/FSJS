...
const MovieDetails = () => {
  ...
  return (
    <>
      {typemors === "movie" && (
        <div className="flex flex-row justify-around bg-white rounded-2xl text-sky-900 ml-60 mr-60 justify-items-center">
          <div className=" mt-5 mb-5 gap-2 text-2xl text-gray-800 font-bold flex flex-col justify-items-center">
          ...
          <div className="mt-5 mb-5 gap-2 text-2xl font-semibold flex flex-col justify-items-center">
      ...
      {typemors === "series" && (
        <div className="flex flex-row justify-evenly bg-white rounded-2xl text-sky-950 ml-60 mr-60">
          <div className="mt-5 mb-5 gap-2 text-2xl font-bold text-sky-950 flex flex-col items-center">
            <p>Released On</p>
            <p>Genre</p>
            <p>Type</p>
            <p>Actors</p>
      ...
      <div className="flex flex-row justify-center text-md text-sky-900 font-semibold mt-5">
      <button 
      onClick={handleless}
